					...
					<div class="card-body">
						...
						<form class="row" action="../updateStatus" method="post">
							...
							<div class="col-md-12">
								...
								<textarea required name="comm" class="form-control" row="3" col=""></textarea>
							</div>
							<input type="hidden" name="id" value="<%=ap.getUserId() %>">
							<input type="hidden" name="did" value= "<%=ap.getDoctor_id() %>">
